...
> **채택 모델: `Qwen/Qwen3.8-27B`** (2026-08-05, Apache-2.0, 26.9B).
...
| repo ID | 크기 | 다운로드 | 비고 |
| --- | --- | --- | --- |
| **`Qwen/Qwen3.8-27B`** | **26.9B** | **1.0M** | ⭐ **채택** (2026-08-05, 최신) |
| `Qwen/Qwen3.8-27B-FP8` | 26.9B | 1.1M | FP8, 서빙용 |
| `Qwen/Qwen3.6-27B` | 26.9B | 6.7M | 안정성 폴백 |
